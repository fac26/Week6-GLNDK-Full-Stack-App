...
(3, 'Morning Glories', 50, 'SPECIAL FIFTH ANNIVERSARY EDITION! Celebrating five years of mind-bending mysteries with a blockbuster Season Two finale! This is our biggest issue yet—(64 pages!) with an ending that will leave EVERYONE talking.' ,'./public/images/3.jpg', 2.99, 3, 'July', 2016, 2),
...
(5,'4001 A.D.: War Mother', 1, 'Witness the battle-scarred debut of Valiant''s top-secret new hero! As the war for 4001 A.D. rages, the coming of War Mother starts now in all-new standalone adventure torn from the pages of the summer''s biggest comics event!' ,'./public/images/5.jpg', 0.99, 4, 'August', 2016, 4),
...
(7,'The Warning', 7, '“ROGUE PLANET” Prin Salu, Archduchess of The Science Guild, and her valet Narrowmeer fold space into The Forbidden Zone. Six months later, Operation: All-Weather devastates The West Coast.','./public/images/7.jpg', 0.99, 3, 'May', 2019, 4),
