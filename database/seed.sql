...
VALUES
  ...
  (4, 'Science Fiction'),
  (5, 'Fantasy'),
  (6, 'Horror') ON CONFLICT DO NOTHING;
...
VALUES
  ...
  (5, 'Berger Books'),
  (6, 'Dark Horse Comics'),
  (7, 'DC Black Label') ON CONFLICT DO NOTHING;
...
VALUES
  ...
  (
    ...
    'Morning Glories',
    50,
    'SPECIAL FIFTH ANNIVERSARY EDITION! Celebrating five years of mind-bending mysteries with a blockbuster Season Two finale! This is our biggest issue yet—(64 pages!) with an ending that will leave EVERYONE talking.',
    '/images/3.jpg',
    2.99,
    3,
    'July',
